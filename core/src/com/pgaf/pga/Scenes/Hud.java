...
public class Hud implements Disposable{
    ...
    public Hud(SpriteBatch sb){
        ...
        levelLabel = new Label(String.format("%d", hp), new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        worldLabel = new Label("SCORE", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        marioLabel = new Label("PUMP", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
    ...
    public static void setHP(int value){
        hp = value;
        levelLabel.setText(String.format("%d", hp));
    }
